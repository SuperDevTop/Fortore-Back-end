            ...
            <div class="card-body p-0">
                <div class="p-3 bg--white">
                    ...
                    <div class="mt-15">
                        ...
                        <span class="text--small">@lang('Joined At')<strong>{{showDateTime($user->created_at,'d M, Y h:i
                                A')}}</strong></span>
                    </div>
                </div>
            </div>
        ...
        <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
            <div class="card-body">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        @lang('Deposit Wallet')
                        <span class="font-weight-bold">{{ $general->cur_sym }}{{ getAmount($user->deposit_wallet)
                            }}</span>
                    </li>

                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        @lang('Interest Wallet')
                        <span class="font-weight-bold">{{ $general->cur_sym }}{{ getAmount($user->interest_wallet)
                            }}</span>
                    </li>
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.users.update',[$user->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group ">
                                <label class="form-control-label font-weight-bold">المدينة <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group ">
                                <label class="form-control-label font-weight-bold">تاريخ الميلاد <span
                                        class="text-danger">*</span></label>
                                <input class="form-control" name="birth_day" value="{{$user->birth_day}}">
                            </div>
                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-group ">
                                <label class="form-control-label font-weight-bold">نقاط الولاء</label>
                                <input class="form-control" type="text" name="lbalance"
                                    value="{{ getAmount($user->loyaltyPointsBalance()) }}">

                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group ">
                                <label class="form-control-label font-weight-bold">@lang('contract') </label>
                                <input class="form-control" type="file" name="contract">
                                @if($user->getMedia('users')->first())
                                <?php $contracts = $user->getMedia('users'); $count = 0 ?>
                                <table class="table table-light">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{$contract->getUrl()}}" target="_blank"
                                                    class="btn btn-sm btn-primary">@lang('View-'.$contract->id)</a>
                                            </td>
                                            <td>
                                                <a href="{{route('admin.users.delete.media',[$contract->id])}}">Delete
                                                    Contract</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                ...
                                <embed src="{{$user->getMedia('users')->first()->getUrl()}}" width="800px"
                                    height="2100px" />
                                <!-- show file from storage -->
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group ">
                                ...
                                <input class="form-control" type="text" name="state" value="{{@$user->address->zip}}">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group ">
                                ...
                                <select name="country" class="form-control">
                                    ...
                                    <option value="{{ $key }}" @if($country->country == @$user->address->country )
                                        selected @endif>{{ __($country->country) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group  col-md-6  col-sm-3 col-12">
                            ...
                            <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                data-toggle="toggle" data-on="Verified" data-off="Unverified" name="ts" @if($user->ts)
                            checked @endif>
                        </div>
            ...
            <form action="{{route('admin.users.addSubBalance', $user->id)}}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            <label class="font-weight-bold">@lang('Select Wallet')<span
                                    class="text-danger">*</span></label>
                            <select name="wallet" class="form-control" required>
                                ...
                                <option value="withdrawals_wallet">@lang('Withdrawal Wallet')</option>
                            </select>
                        </div>
