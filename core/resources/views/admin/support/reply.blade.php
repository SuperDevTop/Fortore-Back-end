                        ...
                        <div class="row">
                            <div class="col-sm-8 col-md-6">
                                ...
                                @elseif($ticket->status == 1)
                                    <span class="badge badge--primary py-1 px-2">Answered</span>
                                @elseif($ticket->status == 2)
                                    <span class="badge badge--warning py-1 px-2">Customer Reply</span>
                                @elseif($ticket->status == 3)
                                    <span class="badge badge--dark py-1 px-2">Closed</span>
                                @endif
                            ...
                            <div class="col-md-6">
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-12 ticket-attachments-message text-muted mt-3">
                                        @lang("Allowed File Extensions: .jpg, .jpeg, .png, .contract")
                                    </div>
                                </div>
                            </div>
                    ...
                    @foreach($messages as $message)
                        ...
                        @else
                            <div class="row border border-warning border-radius-3 my-3 mx-2 admin-bg-reply">
                                ...
                                <div class="col-md-3 border-right text-right">
                                    <h5 class="my-3">{{ optional($message->admin)->name }}</h5>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.ticket') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-fw la-backward"></i> Go Back </a>
@endpush
