        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive(['admin.time-setting*', 'admin.plan-setting*'],3)}}">
                        <i class="menu-icon las la-clipboard-check"></i>
                        <span class="menu-title">@lang('Plan Manage')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive(['admin.time-setting*','admin.plan-setting*'],2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.time-setting')}} ">
                                <a href="{{route('admin.time-setting')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Time Manage')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.plan-setting')}}">
                                <a href="{{route('admin.plan-setting')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Plan Manage')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.report*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.report.transaction.deposit','admin.report.transaction.search'])}}">
                                <a href="{{route('admin.report.transaction.deposit')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Transaction Log')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive(['admin.report.plan','admin.report.plan.search'])}}">
                                <a href="{{route('admin.report.plan')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Invest Plan Log')</span>
                                </a>
                            </li>
