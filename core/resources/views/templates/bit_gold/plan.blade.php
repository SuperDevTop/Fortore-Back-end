        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <div class="section-header">
                        ...
                        <p>@lang(@$planCaption->data_values->sub_heading)</p>
                    </div>
                </div>
            </div><!-- row end -->
            <div class="row mb-none-30 justify-content-center">
                @foreach($plans as $k => $data)
                    @php
                        use App\Models\TimeSetting;$time_name = TimeSetting::where('time', $data->times)->first()
                    @endphp
                    <div class="col-lg-3 mb-30">
                        <div class="package-card text-center bg_img"
                            ...
                            <a href="javascript:void(0)" data-toggle="modal" data-target="#depoModal"
                               data-resource="{{$data}}"
                               class="cmn-btn btn-md mt-4 investButton">@lang('Invest Now')</a>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control" name="wallet_type">
                                            <option
                                                value="deposit_wallet">@lang('Deposit Wallet - '.$general->cur_sym.getAmount(auth()->user()->deposit_wallet))</option>
                                            <option
                                                value="interest_wallet">@lang('Interest Wallet -'.$general->cur_sym.getAmount(auth()->user()->interest_wallet))</option>
