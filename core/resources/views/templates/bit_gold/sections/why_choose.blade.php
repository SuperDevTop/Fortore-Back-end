      ...
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <div class="section-header">
            <h2 class="section-title"><span class="font-weight-normal">{{ __(@$whyChooseCaption->data_values->heading_w)
                }}</span> <b class="base--color">{{ __(@$whyChooseCaption->data_values->heading_c) }}</b></h2>
