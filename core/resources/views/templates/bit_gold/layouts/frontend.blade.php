    ...
    <div class="header__bottom">
      <div class="container">
        <nav class="navbar navbar-expand-xl p-0 align-items-center">
          <a class="site-logo site-title" href="http://holouly.com/"><img src="{{getImage(imagePath()['logoIcon']['path'] .'/logo.png')}}" alt="site-logo"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <li> <a href="#"></a></li>
              <li><a href="#">@lang('Plan')</a></li>
              @foreach($pages as $k => $data)
                                <li><a href="#">{{__($data->name)}}</a></li>
                            @endforeach
