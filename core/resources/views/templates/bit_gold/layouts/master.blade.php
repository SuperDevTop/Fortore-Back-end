      ...
      <div class="header__bottom">
        <div class="container">
          <nav class="navbar navbar-expand-xl p-0 align-items-center">
            <a class="site-logo site-title" href="http://holouly.com/"><img
                src="{{getImage(imagePath()['logoIcon']['path'] .'/logo.png')}}" alt="site-logo"></a>
              ...
              <ul class="navbar-nav main-menu ml-auto">
                ...
                <li class="menu_has_children"><a href="#0">@lang('Account')</a>
                  <ul class="sub-menu">
                    ...
                    <li><a href="{{route('user.pin-code')}}">@lang('Pin Code')</a></li>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 text-md-left text-center">
              <p>@lang('© '.date('Y').' <a href="'.route('home').'" class="base--color">'.$general->sitename.'</a>. All
                rights reserved')</p>
            </div>
            <div class="col-lg-6">
