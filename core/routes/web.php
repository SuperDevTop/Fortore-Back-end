...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::get('user/detail/media/{id}', 'ManageUsersController@delete_media')->name('users.delete.media');
        ...
        Route::delete('user/invests/{id}/{investId}', 'ManageUsersController@deleteInvest')->name('users.invests.delete');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('pin-code', 'UserController@pinCode')->name('pin-code');
            Route::post('pin-code', 'UserController@submitPinCode');
            Route::get('loyalty_points', 'UserController@loyaltyPoints')->name('loyalty_points');
            ...
            Route::get('/deposit/success', 'Gateway\PaymentController@success')->name('success');
            Route::get('/deposit/fail', 'Gateway\PaymentController@fail')->name('fail');
            ...
            Route::post('/plans', 'InvestmentController@createPlanInvestment')->name('buy.plan');
            Route::get('/{invest}/contract', 'InvestmentController@contract')->name('invest.contract');
            Route::post('/{invest}/contract', 'InvestmentController@approveContract')->name('invest.approve_contract');
