...
{
    public function transactionDeposit1()
    {
    ...
    public function transactionInterest1()
    {
    ...
    {
        $page_title = 'Deposit Wallet Transaction Logs';
        $transactions = Transaction::with('user')->latest()->where('wallet_type','deposit_wallet')->paginate(20);
        $empty_message = 'No transactions.';
    ...
    {
        $page_title = 'Interest Wallet Transaction Logs';
        $transactions = Transaction::with('user')->latest()->where('wallet_type','interest_wallet')->paginate(20);
        $empty_message = 'No transactions.';
